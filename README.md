...
| [twitter-roberta-sentiment](twitter_roberta_sentiment_adapter.py) | cardiffnlp/twitter-roberta-base-sentiment-latest | classify | conversational | Python | CC BY 4.0 |
